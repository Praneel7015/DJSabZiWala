document.addEventListener("DOMContentLoaded", function () {
    ...
    addToCartButtons.forEach(function (button) {
        button.addEventListener("click", function () {
            ...
            const productName = productContainer.querySelector("h3 a").textContent;
            const productPrice = parseFloat(productContainer.querySelector("h3 pre").textContent.replace(/[^\d.]/g, '')); // Extract price from the HTML
